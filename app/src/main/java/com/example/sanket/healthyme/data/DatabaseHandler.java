...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_TABLE = "CREATE TABLE " + Constants.TABLE_NAME + "("
                ...
                " TEXT, " + Constants.FOOD_CALORIES_NAME + " INT, " +Constants.FOOD_TIME + " TEXT, "+ Constants.FOOD_QTY + " INT, " + Constants.DATE_NAME + " LONG);";
    ...
    public void addFood(Food food) {
        ...
        values.put(Constants.FOOD_TIME, food.getFoodTime());
        values.put(Constants.FOOD_QTY, food.getFoodQuantity());
    ...
    public ArrayList<Food> getFoods(){
        ...
        Cursor cursor = dba.query(Constants.TABLE_NAME,
                new String[]{Constants.KEY_ID, Constants.FOOD_NAME, Constants.FOOD_CALORIES_NAME,
                        Constants.FOOD_TIME, Constants.FOOD_QTY, Constants.DATE_NAME}, null, null, null, null, Constants.DATE_NAME + " DESC ");
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                food.setFoodTime(cursor.getString(cursor.getColumnIndex(Constants.FOOD_TIME)));
                food.setFoodQuantity(cursor.getInt(cursor.getColumnIndex(Constants.FOOD_QTY)));
